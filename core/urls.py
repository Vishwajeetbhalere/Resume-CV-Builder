...
urlpatterns = [
    ...
    path('cv-edit/expview/experience/',
         views.fetchExperience, name="fetchexperience"),
    path('cv-edit/expview/update_experience/',
         views.updateExperience, name="update_experience"),
    path('cv-edit/expview/delete_experience/',
    ...
    path('cv-edit/skillview/update_skill/',
         views.updateSkill, name="update_skill"),
    path('cv-edit/skillview/delete_skill/',
    ...
    path('cv-edit/refview/update_referee/',
         views.updateReferee, name="update_referee"),
    path('cv-edit/refview/delete_referee/',
         views.deleteReferee, name="delete_referee"),
    ...
    path('cv-edit/proview/update_project/',
         views.updateProject, name="update_project"),
    path('cv-edit/proview/delete_project/',
    ...
    path('cv-edit/cerview/certificate/',
         views.fetchCertificate, name="fetchcertificate"),
    path('cv-edit/cerview/update_certificate/',
         views.updateCertificate, name="update_certificate"),
    path('cv-edit/cerview/delete_certificate/',
         views.deleteCertificate, name="delete_certificate"),
